      ...
      <div class="card">
        <div class="card-body">
          ...
          >
            ...
            <tbody>
              <tr v-for="cliente in listClientes" :key="cliente.clave">
                <td> {{ cliente.clave }} </td>
                <th>{{ cliente.nombre }}</th>
                <th>{{ cliente.ciudad }}</th>
                <th>{{ cliente.rfc }}</th>
                <th>
                  <button @click="showTours(cliente.clave)" class="btn btn-success btn-sm">
                    <i class="fas fa-umbrella-beach"></i>
                  </button>
                  <!-- <button @click="showModal(hotel.clave)" class="btn btn-info btn-sm">
                    <i class="fas fa-pen"></i>
                  </button>
                  <button @click="deleteHotel(hotel.clave)" class="btn btn-danger btn-sm">
...
export default {
  ...
  methods: {
    ...
    async getClientes() {
      const { data } = (await ClientesResource.get()).data;
      console.log('mi data a mostrar', data);
